...
const ITEMS: SlashItem[] = [
  ...
  },
  {
    id: 'messages',
    label: 'Messages',
    sublabel: 'Direct messages with your people',
    icon: (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.9" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5Z" /></svg>),
    keywords: ['message', 'messages', 'chat', 'dm', 'talk', 'people', 'inbox', 'conversation'],
    action: (objectId) => {
      // Same contract as Singularity: this opens a panel rather than becoming a
      // block, so the empty text block it was summoned from goes away with it.
      useCanvasStore.getState().removeObject(objectId);
      useCanvasStore.getState().setEditingId(null);
