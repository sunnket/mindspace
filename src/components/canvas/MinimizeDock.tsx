              ...
              {minimized.map((obj) => {
                ...
                return (
                  <motion.button
                    ...
                    className="group flex items-center gap-2 pl-1.5 pr-3 py-1.5 rounded-full cursor-grab active:cursor-grabbing max-w-[170px] bg-[var(--bg-panel)] backdrop-blur-md border border-[var(--border-strong)] shadow-lg"
                  >
