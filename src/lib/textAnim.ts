...
export const TEXT_ANIM_PRESETS: AnimPreset[] = [
  ...
  /* God Mode (Next Level 100 Expansion) */
  { id: 'overlord',        name: 'Overlord Slam',  category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 36, dur: 800, hint: 'Heavy 3D titanium stamp impact with golden shockwave' },
  { id: 'celestial-burst', name: 'Celestial Burst', category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 30, dur: 880, hint: 'Divine starlight implosion expanding into iridescent glow' },
  { id: 'super-saiyan',    name: 'Super Saiyan',   category: 'God Mode', kind: 'surface', loop: true, dur: 2000, triggers: ['loop'], hint: 'Fiery gold power aura with rising lightning sparks', tag: 'Aa' },
  { id: 'event-horizon',   name: 'Event Horizon',  category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 32, dur: 920, hint: 'Swirling space vortex pulling letters into extreme brilliance' },
  { id: 'dark-matter',     name: 'Dark Matter',    category: 'God Mode', kind: 'surface', loop: true, dur: 3400, triggers: ['loop'], hint: 'Anti-gravity void dispersion with purple shadow trail', tag: 'Aa' },
  { id: 'valkyrie',        name: 'Valkyrie Wings', category: 'God Mode', kind: 'surface', loop: true, dur: 3800, triggers: ['loop'], hint: 'Wings of light opening behind glowing golden text', tag: 'Aa' },
  { id: 'quasar-beam',     name: 'Quasar Beam',    category: 'God Mode', kind: 'surface', loop: true, dur: 2600, triggers: ['loop'], hint: 'High-energy cosmic jet sweep across the letters', tag: 'Aa' },
  { id: 'quantum-tunnel',  name: 'Quantum Tunnel', category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 26, dur: 760, hint: 'Hyper-fast particle tunnel warping letters onto screen' },
  { id: 'titans-fist',     name: 'Titan Slam',     category: 'God Mode', kind: 'kinetic', unit: 'word', stagger: 48, dur: 780, hint: 'Ground-shattering 3D slam that shakes the canvas' },
  { id: 'solaris-crown',   name: 'Solaris Crown',  category: 'God Mode', kind: 'surface', loop: true, dur: 3100, triggers: ['loop'], hint: 'Glowing solar crown flare circling the text', tag: 'Aa' },
  { id: 'zero-point',      name: 'Zero Point',     category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 28, dur: 820, hint: 'Zero-point energy flash expanding into crisp text' },
  { id: 'omega-wave',      name: 'Omega Wave',     category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 34, dur: 840, hint: 'Multi-layered energy wave rolling across text in 3D' },
  { id: 'excalibur',       name: 'Excalibur',      category: 'God Mode', kind: 'kinetic', unit: 'word', stagger: 42, dur: 740, hint: 'Holy sword of light slash across letters with sparks' },
  { id: 'hypernova',       name: 'Hypernova',      category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 32, dur: 900, hint: 'Double supernova explosion with cyan and magenta flares' },
  { id: 'god-mode-glitch', name: 'Divine Glitch',  category: 'God Mode', kind: 'surface', loop: true, dur: 2400, triggers: ['loop'], hint: 'High-frequency reality distortion glitch with gold code', tag: 'Aa' },
  { id: 'divine-shield',   name: 'Divine Shield',  category: 'God Mode', kind: 'surface', loop: true, dur: 3200, triggers: ['loop'], hint: 'Translucent hexagonal energy barrier pulsing around text', tag: 'Aa' },
  { id: 'astral-gate',     name: 'Astral Gate',    category: 'God Mode', kind: 'kinetic', unit: 'char', stagger: 30, dur: 860, hint: 'Stargate ring opening with radial light beams' },
  ...
  /* Reveal (Next Level 100 Expansion) */
  { id: 'laser-cut',       name: 'Laser Cut',      category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 32, dur: 660, hint: 'Laser beam carving letters out of molten glow' },
  { id: 'paper-slice',     name: 'Paper Slice',    category: 'Reveal', kind: 'kinetic', unit: 'word', stagger: 40, dur: 600, hint: 'Sharp diagonal paper slice opening into place' },
  { id: 'matrix-fall',     name: 'Matrix Rain Lock', category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 28, dur: 720, hint: 'Code rain descending and locking into text' },
  { id: 'liquid-fill',     name: 'Liquid Rise',    category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 30, dur: 700, hint: 'Liquid filling text outline from bottom to top' },
  { id: 'spiral-in',       name: 'Spiral Drop',    category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 26, dur: 740, hint: 'Letters spiraling down into place like a tornado' },
  { id: 'magnetic-snap',   name: 'Magnetic Snap',  category: 'Reveal', kind: 'kinetic', unit: 'word', stagger: 38, dur: 620, hint: 'Scattered letters magnetic snap together' },
  { id: 'crystal-grow',    name: 'Crystal Growth', category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 34, dur: 760, hint: 'Crystalline structure growing into letter shapes' },
  { id: 'shadow-cast',     name: 'Shadow Shrink',  category: 'Reveal', kind: 'kinetic', unit: 'word', stagger: 42, dur: 680, hint: 'Long dark shadow shrinking as letters step forward' },
  { id: 'shutter-door',    name: 'Shutter Aperture', category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 30, dur: 640, hint: 'Camera aperture shutter opening per letter' },
  { id: 'flip-stack',      name: '3D Card Stack',  category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 36, dur: 700, hint: 'Card deck 3D flip reveal per letter' },
  { id: 'neon-strike',     name: 'Neon Strike',    category: 'Reveal', kind: 'kinetic', unit: 'word', stagger: 44, dur: 660, hint: 'Lightning strike igniting neon outline into solid text' },
  { id: 'fog-dissolve',    name: 'Fog Dissolve',   category: 'Reveal', kind: 'kinetic', unit: 'word', stagger: 42, dur: 720, hint: 'Dense atmospheric fog dissolving to reveal crisp text' },
  { id: 'cyber-drop',      name: 'Cyber Grid Drop', category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 28, dur: 680, hint: 'Digital blocks dropping down from grid matrix' },
  { id: 'elastic-snap',    name: 'Slingshot Snap', category: 'Reveal', kind: 'kinetic', unit: 'word', stagger: 40, dur: 740, hint: 'Slingshot elastic release snapping words onto screen' },
  { id: 'feather-drift',   name: 'Feather Float',  category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 34, dur: 780, hint: 'Light feather floating down gracefully into letter slots' },
  { id: 'vortex-spin',     name: 'Vortex Whirl',   category: 'Reveal', kind: 'kinetic', unit: 'word', stagger: 38, dur: 720, hint: '3D whirlwind spinning words into center view' },
  { id: 'zoom-blast',      name: 'Zoom Blast',     category: 'Reveal', kind: 'kinetic', unit: 'char', stagger: 24, dur: 660, hint: 'Extreme camera zoom blast snapping to normal scale' },
  ...
  /* Caption (Next Level 100 Expansion) */
  { id: 'halo-reader',     name: 'Halo Hover',     category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 155, dur: 460, hint: 'Glowing halo ring hovering over current reading word' },
  { id: 'laser-pointer',   name: 'Laser Beam Pointer', category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 145, dur: 420, hint: 'Red laser dot guiding across words in real time' },
  { id: 'typewriter-pop',  name: 'Mech Type Punch', category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 130, dur: 360, hint: 'Mechanical punch pop on active spoken word' },
  { id: 'neon-glow-read',  name: 'Neon Edge Read', category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 150, dur: 440, hint: 'Neon outline igniting word by word' },
  { id: 'spring-bounce-read', name: 'Elastic Bounce', category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 140, dur: 480, hint: 'Playful spring bounce on active word' },
  { id: 'sparkle-follow',  name: 'Sparkle Trail',  category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 160, dur: 500, hint: 'Trail of magic sparkles following active word' },
  { id: 'contrast-sweep',  name: 'Invert Reader',  category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 135, dur: 390, hint: 'High contrast inverted color sweep on current word' },
  { id: 'text-scale-beat', name: 'Rhythm Beat',    category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 140, dur: 420, hint: 'Rhythmic pulse scale on spoken word' },
  { id: 'underline-pulse', name: 'Pulse Line',     category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 130, dur: 400, hint: 'Pulsing animated underline tracing words' },
  { id: 'shadow-pop-read', name: 'Shadow Punch',   category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 145, dur: 430, hint: 'Drop shadow popping under spoken word' },
  { id: 'cyber-scan-read', name: 'Cyber Scanner',  category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 150, dur: 450, hint: 'Horizontal scanner line reading across words' },
  { id: 'bubble-pop-read', name: 'Bubble Pop Read', category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 135, dur: 410, hint: 'Bubble pop effect on active word' },
  { id: 'gold-leaf-read',  name: 'Gold Foil Read', category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 155, dur: 470, hint: 'Gold leaf foil flash on current word' },
  { id: 'blur-sharpen-read', name: 'Focus Reader', category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 140, dur: 430, hint: 'Blurred words sharpening one by one as read' },
  { id: 'marker-brush',    name: 'Paint Marker',   category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 130, dur: 400, hint: 'Paintbrush marker stroke painting under words' },
  { id: 'wave-runner',     name: 'Wave Runner',    category: 'Caption', kind: 'kinetic', unit: 'word', stagger: 150, dur: 460, hint: 'Continuous wave motion running through current word' },
  ...
  /* Ambient (Next Level 100 Expansion) */
  { id: 'cyber-pulse',     name: 'Cyberpunk Pulse', category: 'Ambient', kind: 'surface', loop: true, dur: 2600, triggers: ['loop'], hint: 'Cyberpunk neon grid pulsing softly underneath', tag: 'Aa' },
  { id: 'galaxy-drift',    name: 'Galaxy Drift',   category: 'Ambient', kind: 'surface', loop: true, dur: 4800, triggers: ['loop'], hint: 'Deep space galaxy star field drifting through text', tag: 'Aa' },
  { id: 'hologram-flicker', name: 'Holo Scanline',  category: 'Ambient', kind: 'surface', loop: true, dur: 3400, triggers: ['loop'], hint: 'Sci-fi hologram scanlines with gentle flicker', tag: 'Aa' },
  { id: 'plasma-flow',     name: 'Plasma Flow',    category: 'Ambient', kind: 'surface', loop: true, dur: 4100, triggers: ['loop'], hint: 'Liquid plasma gradient morphing continuously', tag: 'Aa' },
  { id: 'electric-arc',    name: 'Electric Arc',   category: 'Ambient', kind: 'surface', loop: true, dur: 2300, triggers: ['loop'], hint: 'Crackling blue electric arcs dancing around text', tag: 'Aa' },
  { id: 'golden-hour',     name: 'Golden Hour',    category: 'Ambient', kind: 'surface', loop: true, dur: 3900, triggers: ['loop'], hint: 'Warm golden hour sunlight shimmer sweeping across', tag: 'Aa' },
  { id: 'emerald-shimmer', name: 'Emerald Glint',  category: 'Ambient', kind: 'surface', loop: true, dur: 3300, triggers: ['loop'], hint: 'Rich emerald green metallic shimmer flow', tag: 'Aa' },
  { id: 'ruby-glow',       name: 'Ruby Glow',      category: 'Ambient', kind: 'surface', loop: true, dur: 3100, triggers: ['loop'], hint: 'Deep ruby red gemstone glow breathing slowly', tag: 'Aa' },
  { id: 'sapphire-drift',  name: 'Sapphire Wave',  category: 'Ambient', kind: 'surface', loop: true, dur: 4400, triggers: ['loop'], hint: 'Deep sapphire blue ocean gradient wave', tag: 'Aa' },
  { id: 'violet-haze',     name: 'Violet Haze',    category: 'Ambient', kind: 'surface', loop: true, dur: 3600, triggers: ['loop'], hint: 'Mystic violet haze drifting through text', tag: 'Aa' },
  { id: 'copper-plate',    name: 'Copper Plate',   category: 'Ambient', kind: 'surface', loop: true, dur: 2900, triggers: ['loop'], hint: 'Antique polished copper metallic sheen', tag: 'Aa' },
  { id: 'prism-light',     name: 'Prism Light',    category: 'Ambient', kind: 'surface', loop: true, dur: 4300, triggers: ['loop'], hint: 'Rainbow prism light refraction floating across text', tag: 'Aa' },
  { id: 'starlight-twinkle', name: 'Starlight Glint', category: 'Ambient', kind: 'surface', loop: true, dur: 3700, triggers: ['loop'], hint: 'Soft starlight sparkles twinkling on letters', tag: 'Aa' },
  { id: 'sunset-glow',     name: 'Sunset Glow',    category: 'Ambient', kind: 'surface', loop: true, dur: 4500, triggers: ['loop'], hint: 'Warm dusk sunset gradient breathing', tag: 'Aa' },
  { id: 'toxic-neon',      name: 'Toxic Glow',     category: 'Ambient', kind: 'surface', loop: true, dur: 2500, triggers: ['loop'], hint: 'Radioactive toxic green glow pulse', tag: 'Aa' },
  { id: 'shadow-spin',     name: 'Orbit Shadow',   category: 'Ambient', kind: 'surface', loop: true, dur: 3500, triggers: ['loop'], hint: '3D directional light source casting rotating shadow', tag: 'Aa' },
  { id: 'ice-crystal',     name: 'Ice Crystal',    category: 'Ambient', kind: 'surface', loop: true, dur: 3300, triggers: ['loop'], hint: 'Frosted ice crystal shimmer glinting on edges', tag: 'Aa' },
  ...
  /* Signature (Next Level 100 Expansion) */
  { id: 'cyber-glitch-v2', name: 'Cyber Corruption', category: 'Signature', kind: 'surface', loop: true, dur: 2500, triggers: ['loop'], hint: 'Advanced multi-band chromatic glitch corruption', tag: 'Aa' },
  { id: 'holodeck',        name: 'Holodeck Matrix', category: 'Signature', kind: 'kinetic', unit: 'char', stagger: 28, dur: 740, hint: 'Sci-fi holodeck grid projection building the text' },
  { id: 'fire-flame-burst', name: 'Flame Burst',   category: 'Signature', kind: 'surface', loop: true, dur: 2300, triggers: ['loop'], hint: 'Raging inferno flames rising with sparks', tag: 'Aa' },
  { id: 'black-hole-pull', name: 'Black Hole Lens', category: 'Signature', kind: 'surface', loop: true, dur: 3300, triggers: ['loop'], hint: 'Gravitational event horizon warping text lines', tag: 'Aa' },
  { id: 'hyper-streak',    name: 'Speed Streak',   category: 'Signature', kind: 'kinetic', unit: 'word', stagger: 42, dur: 680, hint: 'Light streak motion blur as text glides in' },
  { id: 'atomic-spark',    name: 'Atomic Core',    category: 'Signature', kind: 'surface', loop: true, dur: 2100, triggers: ['loop'], hint: 'Nuclear atomic fusion core sparking in text center', tag: 'Aa' },
  { id: 'shadow-realm',    name: 'Shadow Void',    category: 'Signature', kind: 'kinetic', unit: 'char', stagger: 32, dur: 780, hint: 'Shadow realm portal summoning text from dark void' },
  { id: 'time-warp',       name: 'Time Warp Arc',  category: 'Signature', kind: 'surface', loop: true, dur: 3100, triggers: ['loop'], hint: 'Time warp distortion bending space-time around text', tag: 'Aa' },
  { id: 'quantum-entangle', name: 'Entangled State', category: 'Signature', kind: 'kinetic', unit: 'char', stagger: 26, dur: 720, hint: 'Quantum entangled letter pairs flashing in sync' },
  { id: 'inferno-rise',    name: 'Inferno Rise',   category: 'Signature', kind: 'surface', loop: true, dur: 2500, triggers: ['loop'], hint: 'Hellfire inferno rising from text baseline', tag: 'Aa' },
  { id: 'arc-lightning',   name: 'Tesla Lightning', category: 'Signature', kind: 'surface', loop: true, dur: 2200, triggers: ['loop'], hint: 'Tesla coil arc lightning firing across letter tops', tag: 'Aa' },
  { id: 'synthwave-80s',   name: 'Synthwave Chrome', category: 'Signature', kind: 'surface', loop: true, dur: 3500, triggers: ['loop'], hint: '80s synthwave chrome text with sunset grid reflections', tag: 'Aa' },
  { id: 'cyber-terminal',  name: 'Hacker Terminal', category: 'Signature', kind: 'kinetic', unit: 'char', special: 'typewriter', dur: 48, hint: 'Hacker terminal green text with scanlines and cursor' },
  { id: 'divine-light',    name: 'Divine Beam',    category: 'Signature', kind: 'surface', loop: true, dur: 3400, triggers: ['loop'], hint: 'Heavenly light beams bursting out from text edges', tag: 'Aa' },
  { id: 'chromatic-shift', name: 'RGB Shift Wave', category: 'Signature', kind: 'surface', loop: true, dur: 2400, triggers: ['loop'], hint: 'RGB split chromatic aberration pulsing rhythmically', tag: 'Aa' },
  { id: 'laser-grid-scan', name: 'Dual Laser Scan', category: 'Signature', kind: 'surface', loop: true, dur: 2700, triggers: ['loop'], hint: 'Dual laser grid lines scanning text vertically', tag: 'Aa' },
  ...
  /* Playful (Next Level 100 Expansion) */
  { id: 'bubble-gum',      name: 'Bubble Gum Pop', category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 35, dur: 680, hint: 'Squishy bubble gum expanding and popping into text' },
  { id: 'slingshot',       name: 'Slingshot',      category: 'Playful', kind: 'kinetic', unit: 'word', stagger: 44, dur: 720, hint: 'Slingshot pull back and spring release' },
  { id: 'bouncy-ball',     name: 'Bouncy Ball',    category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 30, dur: 760, hint: 'Bouncy rubber ball bouncing letters into place' },
  { id: 'wave-dance',      name: 'Wave Dance',     category: 'Playful', kind: 'kinetic', unit: 'char', loop: true, stagger: 50, dur: 1300, triggers: ['loop'], hint: 'Playful Mexican wave dancing through letters' },
  { id: 'wobble-jelly',    name: 'Jelly Wobble',   category: 'Playful', kind: 'surface', loop: true, dur: 1700, triggers: ['loop'], hint: 'Tipsy jelly wobble on rubbery baseline', tag: 'Aa' },
  { id: 'pop-tart',        name: 'Toaster Pop',    category: 'Playful', kind: 'kinetic', unit: 'word', stagger: 46, dur: 640, hint: 'Snappy pop-tart pop out of toaster' },
  { id: 'accordion',       name: 'Accordion Stretch', category: 'Playful', kind: 'kinetic', unit: 'word', stagger: 42, dur: 700, hint: 'Accordion stretch and compress animation' },
  { id: 'cartoon-boing',   name: 'Cartoon Boing',  category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 34, dur: 680, hint: 'High-pitched cartoon boing spring jump' },
  { id: 'jack-box',        name: 'Jack-in-Box',    category: 'Playful', kind: 'kinetic', unit: 'word', stagger: 48, dur: 740, hint: 'Jack-in-the-box spring surprise pop' },
  { id: 'yo-yo-spin',      name: 'Yo-Yo Spin',     category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 36, dur: 710, hint: 'Yo-yo spin down and snap back up' },
  { id: 'domino-cascade',  name: 'Domino Chain',   category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 32, dur: 660, hint: '3D domino chain reaction knock-down' },
  { id: 'trampoline-bounce', name: 'Trampoline High', category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 34, dur: 750, hint: 'High-vaulting trampoline spring jump' },
  { id: 'pinball-bounce',  name: 'Pinball Bumper Read', category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 36, dur: 680, hint: 'Pinball bumper ricochet popping letters' },
  { id: 'slime-drip-v2',   name: 'Gooey Slime',    category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 32, dur: 720, hint: 'Gooey slime dripping down into letter forms' },
  { id: 'balloon-pop-v2',  name: 'Party Balloon',  category: 'Playful', kind: 'kinetic', unit: 'char', stagger: 36, dur: 670, hint: 'Party balloon inflate and snap into crisp text' },
  { id: 'wiggle-head',     name: 'Wiggle Head',    category: 'Playful', kind: 'kinetic', unit: 'word', stagger: 45, dur: 620, hint: 'Cartoon head-wiggle and snappy pop' },
];
